 ...
 */
template <typename T>
void DFS(AdjacencyList<T> &g, Node<T> *src) {
  g.reset();
 ...
 */
template <typename T>
void DFS_iterative(AdjacencyList<T> &g, Node<T> *src, bool print = false) {
  g.reset();
 ...
 */
template<typename T>
void BFS(AdjacencyList<T> &g, Node<T> *src, bool print = false) {
  g.reset();
